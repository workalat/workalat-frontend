                    ...
                    <table className="min-w-full">
                      <thead className="py-2 border-b border-black/20">
                        <tr>
                          ...
                          <th className="p-4 text-left">Admin Status</th>
                      ...
                      <tbody>
                        {projectData.map((data, i) => (
                          ...
                          >
                            ...
                            <td className="p-4">
                                                <p className="text-gray-500 text-[15px] capitalize">{data?.projectStatusAdmin ? "Approved" : "Not Approved" }</p>
                                            </td>
                            ...
                            <td className="p-4">
                              <button
                                onClick={()=>{router.push(
                                    `/client/my-projects/details/${data?._id}`
                                  )}}
