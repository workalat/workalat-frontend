                                        ...
                                        {allTicketData.map((user: any) => (
                                            <tr key={user?._id} className="border-b border-black/20">
                                                ...
                                                <td className="p-4">
                                                    ...
                                                    {
                                                            user?.ticketStatus !== "closed" ? <Link href={`/professional/dashboard/support-tickets/view/${user?._id}`} className="flex gap-2 justify-center items-center px-2 py-2 rounded-md bg-[#7A7A7A] text-white text-[15px] font-semibold w-[200px]"><RiCloseFill className="size-[15px] rounded-sm text-[#07242B] bg-white capitalize" />Waiting on <span className="capitalize">{user?.ticketStatus}</span> </Link> : user?.ticketStatus == "closed" && <Link  href={`/professional/dashboard/support-tickets/view/${user?._id}`} className="px-4 py-2 rounded-md bg-[#00A770] text-white text-[15px] font-semibold">Closed</Link>
                                                    }
                                                </td>
