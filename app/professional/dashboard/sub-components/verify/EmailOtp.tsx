...
const EmailOtpProfessional = ({verifyEmailData,setVerifyEmailData ,isEditEnable} : any) => {
  ...
  const {verifyOtp,sendEmailOtp}  : any  = useUserContext();
...
export default EmailOtpProfessional;
