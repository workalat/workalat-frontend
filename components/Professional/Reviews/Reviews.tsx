                ...
                <div className="w-full flex flex-col-reverse sm:flex-row justify-start">
                    ...
                    <div className="w-full sm:w-[300px] p-3">
                        <div className="w-full bg-[#F3F3F3] rounded-md p-4 text-center">
                            ...
                            <button className="flex items-center justify-center gap-2 px-4 py-2 rounded-md bg-secondary font-semibold mx-auto text-center mt-2 w-full">Refer Now <IoArrowForwardSharp className="size-4" /></button>
                        </div>
                    </div>
                </div>
            </div>
