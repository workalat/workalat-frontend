...
const Guides_section = () => {
    ...
    const guideTexts = [
        "The Get Hired Guarantee",
        "Welcome to Whatworks",
        "Displaying prices on your profile",
        "The Get Hired Guarantee",
        ...
        <div className="relative bg-[#EEEEEE] mt-2 pb-20">
            ...
            <div className="pt-6 container mx-auto max-w-7xl px-6">
                ...
                <div className="bg-yellow-500 flex items-center w-full mx-auto px-8 py-5 rounded-md -mt-14 mb-5">
                    <span className="text-black text-[20px] sm:text-[20px] md:text-[22px] lg:text-[24px] font-bold">Guides</span>
                </div>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-y-[2.1%] sm:gap-y-[2.1%] md:gap-y-[2.3%] lg:gap-y-[2.5%] xl:gap-y-[2.7%] gap-x-[3%] sm:gap-x-[3%] md:gap-x-[4%] lg:gap-x-[5%] xl:gap-x-[6%]'>
                    {guideTexts.map((text, index) => (
                        <div key={index} className={`flex flex-col items-center pl-4 mt-4`} onClick={handleClick}> {/* Add onClick */}
                            ...
                            <button
                                className="px-[14%] lg:text-xs text-[8px] md:text-[10px] sm:text-[8px] py-[10%] bg-[#07242B] text-white whitespace-nowrap min-w-[100%] rounded-md mt-2 sm:w-auto cursor-pointer"
                            >
                                {text}
                            </button>
                        </div>
